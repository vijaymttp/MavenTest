...
public class SauceREST {
	...
	public SauceREST(String username, String accessKey) {
		...
		System.out.println(
				"inside constructor in SauceREST: username is:" + this.username + " accesskeys is:" + this.accessKey);
	}
	...
	public void jobPassed(String jobId) {
		/*
		 * sauceJob.put("passed", true); updateJobInfo(jobId, sauceJob);
		 */
		System.out.println("in jobPassed");
	...
	public void jobFailed(String jobId) {
		/*
		 * sauceJob.put("failed", false); updateJobInfo(jobId, sauceJob);
		 */
	...
	public void updateJobInfo(String jobId, Map<String, Object> updates) {
		System.out.println("********************SauceREST************************");
		System.out.println("In updateJobInfo of SauceREST class:jobid:" + jobId + " updates:" + updates);
